                ...
                <div className='space-y-8'>
                    ...
                    <div className='border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm'>
                        ...
                        <div className='space-y-3 text-center'>
                            <h1 className='text-3xl font-bold text-zinc-50 truncate'>Hi {data?.user?.name || "User"}!</h1>
                            <p className='text-sm text-zinc-400'>Authenticated User</p>
                        </div>
                    </div>

                    {/*User Details Card*/}
                    <div className='border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm space-y-4'>
